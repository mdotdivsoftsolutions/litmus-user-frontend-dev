...
const FAQS = [
  { q: "In how many cities does Litmus provide food testing services?", a: "Litmus currently provides seamless sample collection and testing services in all major metro cities including Chennai, Mumbai, Delhi, Bangalore, Hyderabad, and Kolkata." },
