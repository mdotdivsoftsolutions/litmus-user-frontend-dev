...
export const TestsStatsStrip = () => {
  return (
    <div className="border-b border-border bg-card w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-start sm:justify-center gap-6 sm:gap-10 overflow-x-auto text-xs sm:text-sm text-muted-foreground [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] w-full min-w-0 max-w-full">
