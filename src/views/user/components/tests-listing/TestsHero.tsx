...
export const TestsHero = ({ search, setSearch, tests = [], onSearch }: TestsHeroProps) => {
  return (
    <div className="relative bg-white pt-20 md:pt-28 pb-8 md:pb-10 flex flex-col justify-center border-b border-slate-100/60 w-full overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 w-full min-w-0">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 w-full min-w-0">
          <div className="flex-1 text-center lg:text-left space-y-6 py-4 lg:py-0 group w-full min-w-0">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 sm:gap-8 pt-2 flex-wrap">
          ...
          <div className="flex-1 relative w-full lg:w-auto min-w-0">
