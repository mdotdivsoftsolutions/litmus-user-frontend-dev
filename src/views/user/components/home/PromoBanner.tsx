                        ...
                        {actions.map((action) => {
                           ...
                           const linkEl = (
                              <a
                                 ...
                                 className={cn(
                                    "flex items-center gap-3 px-4 py-3.5 rounded-xl border backdrop-blur-sm transition-all duration-200 cursor-pointer group/action w-full sm:w-auto justify-center shadow-sm",
                                    action.cardBg,
                                    action.border,
                                    action.hoverShadow
                                 )}
                              >
                                 ...
                                 <span className="text-sm text-slate-600 font-medium whitespace-nowrap">
                                    {action.label}{" "}
                                    <strong className="text-slate-900 font-bold">{action.highlight}</strong>
                                 </span>
                              </a>
                           );
