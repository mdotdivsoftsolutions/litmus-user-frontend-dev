...
import { ChevronRight, Phone, MessageSquare, Mail, Shield, CheckCircle2, Loader2 } from "lucide-react";
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                  ...
                  <Button
                    ...
                    className="w-full h-12 rounded-xl bg-gradient-to-r from-[#006b88] to-[#004B60] hover:opacity-90 text-white font-semibold text-xs active:scale-95 transition-all"
                  >
                    {isSubmitting ? (
                      <>
